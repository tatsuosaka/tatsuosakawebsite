export type Project = {
  ...
  section: 'gaming' | 'commercial';
  thumbnail: string;
  format: 'horizontal' | 'vertical';
  youtubeUrl: string;
};

// Move links between these arrays to categorize them
const gamingLinks = [
  ...
  "https://youtube.com/shorts/2bgfioFY07U?feature=share",
  "https://youtube.com/shorts/1ghMbti-yYU?feature=share",
  "https://youtu.be/Om63QlQ2wTg",
  "https://youtu.be/TRcUnJttJeU"
];
...
const commercialLinks = [
  ...
  "https://www.youtube.com/shorts/Vz3MUMM3NKs",
...
const mapProjects = (links: string[], section: 'gaming' | 'commercial', startIndex: number): Project[] => {
  return links.map((url, index) => {
    ...
    return {
      ...
      youtubeId: id,
      title: isVertical ? `Project ${globalIndex}` : `Video ${globalIndex}`,
      category: isVertical 
...
export const projects: Project[] = [
  ...mapProjects(gamingLinks, 'gaming', 0),
  ...mapProjects(commercialLinks, 'commercial', gamingLinks.length)
];
